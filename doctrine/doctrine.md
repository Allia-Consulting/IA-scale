...
- **Plan de l'utilisateur quotidien.** Cette doctrine modélise en profondeur la gouvernance. Le quotidien du rôle Utilisateur — le cockpit du collaborateur, dit « Tour de contrôle » — est désormais **conçu et cadré** : le parti-pris d'expérience et l'orientation technique (SPFx) sont figés dans le contrat socle `contrats/socle/tour-de-controle.md` (promu), et la construction est inscrite au chantier `T-0014`. Il **reste à construire** — c'est pourquoi il figure encore ici — et demeure le vrai test de l'adoption.
