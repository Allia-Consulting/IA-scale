...
- **La trajectoire de la firme cadence la fédération de la promotion** (§10) — le principe est ici, l'état réel est au registre : le gardien conserve le socle et délègue le reste ; l'agent-gardien auto-approuvera le faible risque contre politique. Le « qui promeut quoi » — titulaires, périmètres, suppléances — vit dans le **registre des délégations `contrats/socle/organisation.md` §4.1**, seule source de vérité. La première délégation de promotion est advenue dès la phase *Fondation* (3 juillet 2026, contrat local communication) : la fédération suit le besoin réel, pas un cap d'effectif.
