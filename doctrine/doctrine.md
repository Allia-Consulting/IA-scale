...
- **Fédération de la promotion.** À 50-200 collaborateurs, un promoteur humain unique sature. La première délégation par périmètre est advenue dès la Fondation (Communication) ; le « qui promeut quoi » — titulaires, périmètres, suppléances — vit au registre des délégations `contrats/socle/organisation.md` §4.1 (cf. §10 bis). Restent à construire : la généralisation de la délégation par domaine et l’auto-approbation du faible risque *contre politique* par l’agent-gardien (`T-0020-c`). Le gardien conserve le socle, délègue le reste.
