...
export default class TourDeControle extends React.Component<ITourDeControleProps> {
  public render(): React.ReactElement<ITourDeControleProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section className={`${styles.tourDeControle}`}>
