...
Un serveur [Model Context Protocol](https://modelcontextprotocol.io), exposé en **HTTP streamable**, qui donne à un agent **quinze** opérations sur Microsoft Graph, et quinze seulement :
