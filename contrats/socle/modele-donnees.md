...
> **Version** : 1.11 — *promu*. **Statut** : contrat socle — fait foi.
...
| Candidat | un candidat au recrutement | Liste « Candidats » | id candidat | source · **données personnelles (RGPD)** |
| Synthèse d'entretien | appréciation structurée d'un entretien | Liste « Candidats-Synthèses » (rattachée au candidat) | id synthèse | dérivé · **données personnelles (RGPD)** |
...
| Liste « Candidats » | site AlliaConsuling / Liste Candidats | **accès restreint** | ⚠️ **données personnelles candidat (RGPD)** — recrutement. Colonne **étape** (sourcing / entretien 1 / entretien 2 / proposition / accepté / refusé / vivier) ; colonne **date-dernier-contact** (purge vivier 2 ans glissants, T-0013-d) ; colonne **date-aboutissement-instruction** (purge instruction 3 mois, T-0013-d). Cadre `contrats/socle/rgpd-recrutement-candidats.md`. **Journalisation à activer** avant accès agent réel (cf. T-0003). |
| Liste « Candidats-Synthèses » | site AlliaConsuling / Liste Candidats-Synthèses | **écriture (dérivés via Zone-de-proposition)** | ⚠️ **données personnelles candidat (RGPD)**. Une synthèse d'entretien par entretien, **rattachée** à l'item Candidat (lookup). Le dérivé **naît en Zone-de-proposition** (T-0013-c) et ne rejoint cette liste **qu'à validation** (promotion tracée) ; les **notes brutes** sont éphémères et ne sont jamais une entité (cadre §4). Synthèse **accessible au candidat** (droit d'accès, cadre §7). **Journalisation à activer** avant accès agent réel (cf. T-0003). |
