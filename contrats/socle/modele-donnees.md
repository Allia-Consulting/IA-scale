...
> **Version** : 1.21 — *candidat* (PR T-0035 reprise n°3 ; le gardien promeut). **Statut** : contrat socle — fait foi.
...
- **Ouvrabilité À FROID (candidat v1.21, T-0035 reprise n°3).** Un gabarit fabriqué ne vaut que s'il est
  ...
  (`count:0` lu sans session) ; un échec froid **avorte** l'instanciation (rollback borné). Le count:0 doit
  être vrai **à froid**, pas seulement en session.
