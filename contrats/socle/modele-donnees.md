...
> **Version** : 1.19 — *promu*. **Statut** : contrat socle — fait foi.
...
- **Boucle agent** : lun→ven, 05h00 et 13h00 (heure de Paris). À chaque passage, l'agent lit les
  ...
  par copie de la souche vierge avant de régénérer : l'instanciation est **SYSTÉMATIQUE et machine**
  (décision gardien du 14/07/2026), plus jamais un geste humain ; **le gabarit canon vierge reste la
  seule souche**.
