...
> **Version** : 1.13 — *candidat*. **Statut** : contrat socle — *en attente de promotion par le gardien*.
...
| Source | `Source` | Choix (unique) | LinkedIn / cooptation / candidature spontanée / chasseur — sans ajout manuel |
| Email | `Email` | Texte | contact (recontact vivier) |
| Téléphone | `Telephone` | Texte | optionnel |
| Étape | `Etape` | Choix (unique) | entretien 1 / entretien 2 / entretien 3 / proposition / accepté / refusé — pas de défaut, pas d'ajout manuel |
...
| Étape | `EtapeSynthese` | Choix | entretien 1 / entretien 2 / entretien 3 |
